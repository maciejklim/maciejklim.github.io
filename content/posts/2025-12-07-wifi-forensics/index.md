...
image: "feature.jpg"
slug: "Windows WiFi Forensics"
---

> Table of Contents
- [Windows records every WiFi network you joined](#windows-records-every-wifi-network-you-joined)
- [How to see the data](#how-to-see-the-data)
- [Investigating BSSIDs (access points)](#investigating-bssids-access-points)
- [Disabling Windows access to BSSID metadata](#disabling-windows-access-to-bssid-metadata)
- [Removing stored WiFi profiles](#removing-stored-wifi-profiles)
- [Closing insight](#closing-insight)
