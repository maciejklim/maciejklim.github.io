...
slug: "Windows Prefetch Forensics"

---

> Table of Contents
- [Did you know?](#did-you-know)
- [What's in your prefetch?](#whats-in-your-prefetch)
- [Analyzing prefetch files](#analyzing-prefetch-files)
- [Using PECmd](#using-pecmd)
- [Sample PECmd Output](#sample-pecmd-output)
  - [What to look for](#what-to-look-for)
  - [Filtering keywords](#filtering-keywords)
- [Applying PECmd to Malware Analysis](#applying-pecmd-to-malware-analysis)
...
You can open your prefetch directory by running ```prefetch```, or with an **elevated** Powershell. Here we see all recently executed binaries and their timestamp.
