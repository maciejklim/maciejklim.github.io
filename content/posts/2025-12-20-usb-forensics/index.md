...
slug: "Windows USB Forensics"
---

> Table of Contents
- [Windows never forgets your USB](#windows-never-forgets-your-usb)
- [Where Windows stores USB history in registry](#where-windows-stores-usb-history-in-registry)
- [The myth of executing binaries from USB](#the-myth-of-executing-binaries-from-usb)
- [Investigating timestamps](#investigating-timestamps)
- [Rebuilding USB connection history](#rebuilding-usb-connection-history)
...
## The myth of executing binaries from USB
